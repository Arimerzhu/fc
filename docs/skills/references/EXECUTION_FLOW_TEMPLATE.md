...
| 4 | 布尔差集 | part boolean cut BasePlate Pillar | 步骤 2, 3 |
...
fc part boolean cut BasePlate Pillar --name BasePlate_With_Hole --json
...
# 步骤 4: 布尔差集 (打通孔)
fc part boolean cut BasePlate Hole_Cylinder --name BasePlate_With_Hole --json
